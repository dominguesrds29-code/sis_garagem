(function (e, t) {
    ...
    function t() {
        var e = Ae.innerParams.get(this), t = Ae.domCache.get(this);
    ...
    function n(e) {
        ...
        var t, n = R(), o = "string" == typeof e.target ? document.querySelector(e.target) : e.target;
        ...
        var i = M(), l = N(), d = W().querySelector("#" + k.content), u = Q(), c = F(), p = Y(), g = X(), m = J();
        ...
        var y = K(), v = parseInt(null === e.currentProgressStep ? _e.getQueueStep() : e.currentProgressStep, 10);
    ...
    var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        B = x(["success", "warning", "info", "question", "error"]), A = {previousBodyPadding: null},
        E = function (e, t) {
        ...
        ne = function (e) {
            ...
            o.appendChild(n);
            var i = R(), a = W(), r = O(a, k.input), s = O(a, k.file), l = a.querySelector("." + k.range + " input"),
                d = a.querySelector("." + k.range + " output"), u = O(a, k.select),
                c = a.querySelector("." + k.checkbox + " input"), p = O(a, k.textarea);
            ...
            if (o) {
                ...
                var i = function () {
                    $() || (ce(), window.removeEventListener("keydown", ue.keydownHandler, {capture: !0}), ue.keydownHandlerAdded = !1), n.parentNode && n.parentNode.removeChild(n), _([document.documentElement, document.body], [k.shown, k["height-auto"], k["no-backdrop"], k["has-input"], k["toast-shown"]]), Z() && (se(), de()), null !== t && "function" == typeof t && setTimeout(function () {
                        t()
                    })
                };
            ...
            useRejections: !1,
            expectRejections: !1
        }, me = ["useRejections", "expectRejections"], fe = function (e) {
            ...
            isValidParameter: fe, isDeprecatedParameter: he, argsToParams: function (e) {
                var t = {};
                switch (a(e[0])) {
                    case"string":
                ...
                return Y().click()
            }, getPopup: R, getTitle: N, getContent: W, getImage: U, getButtonsWrapper: function () {
            ...
            }, getActions: Q, getConfirmButton: F, getCancelButton: Y, getFooter: J, isLoading: function () {
    ...
    var Ae = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap}, Ee = {
        email: function (e, t) {
        ...
        hideLoading: t, disableLoading: t, getInput: function (e) {
            var t = Ae.innerParams.get(this), n = Ae.domCache.get(this);
            ...
            return new Promise(function (e, n) {
                ...
                for (var g = function (e) {
                    ...
                    var i = n || window.event, e = i.target || i.srcElement, a = r.confirmButton, s = r.cancelButton,
                        c = a && (a === e || a.contains(e)), m = s && (s === e || s.contains(e));
                    switch (i.type) {
                        case"click":
                ...
                ue.keydownHandlerAdded && (window.removeEventListener("keydown", ue.keydownHandler, {capture: !0}), ue.keydownHandlerAdded = !1), o.toast || (ue.keydownHandler = function (t) {
                    return x(t, o)
                }, window.addEventListener("keydown", ue.keydownHandler, {capture: !0}), ue.keydownHandlerAdded = !0), t.enableButtons(), t.hideLoading(), t.resetValidationError(), o.input && L(document.body, k["has-input"]);
                for (var B = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], A = void 0, E = 0; E < B.length; E++) {
                    var P = k[B[E]], _ = O(r.content, P);
                ...
                switch (o.input) {
                    ...
                    case"file":
                        ...
                        break;
                    case"range":
                        var R = O(r.content, k.range), I = R.querySelector("input"), N = R.querySelector("output");
                    ...
                    case"select":
                        ...
                        D = function (e) {
                            e.forEach(function (e) {
                                var t = c(e, 2), n = t[0], i = t[1], a = document.createElement("option");
                    ...
                    case"radio":
                        ...
                        K.innerHTML = "", D = function (e) {
                            e.forEach(function (e) {
                                var t = c(e, 2), n = t[0], i = t[1], a = document.createElement("input"),
                        ...
                        break;
                    case"checkbox":
                        var z = O(r.content, k.checkbox), F = t.getInput("checkbox");
