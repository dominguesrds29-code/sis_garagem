        ...
        <div class="row layout-spacing layout-top-spacing">
            <div class="col-lg-12">
                ...
                <div class="widget-content widget-content-area">
                    <form name="cadUsuario" method='post' action="{{ route('user.update', $user->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-row mb-2">
                            <div class="form-group col-md-12">
                                <label>E-mail</label>
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="E-mail" value="{{ old('email') ?? $user->email }}">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                                            <label>
                                                <label class="switch s-outline s-outline-success">
                                                    ...
                                                    <span class="slider round mt-2"></span>
                                                </label> <p style="color: #000; display: inline-block;"> {{ $permission }} </p> {{ in_array($permission, $inheritancePermissions) ? ' - (Herdado)' : '' }}</label>
                                        </div>
                                    @endforeach
                                </div>
