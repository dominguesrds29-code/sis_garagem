                    ...
                    <form name="cadUsuario" method='post' action="{{ route('user.store') }}">
                        ...
                        <div class="form-row mb-2">
                            <div class="form-group col-md-12">
                                ...
                                <select class="placeholder form-control users @error('user_war_name') is-invalid @enderror"
                                    name="user_war_name">
                                    @forelse($users as $user)
                                        <option
                                            value="{{ $user->id }}#{{ $user->grade }}#{{ $user->specialty }}#{{ $user->war_name }}"
                                    ...
                                    @foreach ($roles as $role)
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                                            <label>
                                                ...
                                                <p style="color: #000; display: inline-block;"> {{ $role }} </p>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
