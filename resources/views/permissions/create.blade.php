        ...
        <div class="row layout-spacing layout-top-spacing">
            <div class="col-lg-12">
                ...
                <div class="widget-content widget-content-area">
                    <form name="cadPermission" method='post' action="{{ route('permission.store') }}">
                        @csrf
                        @method('POST')
                        <div class="form-row mb-2">
                            <div class="form-group col-md-12">
                                <label>Nome</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Nome da Permissão" autofocus>
