                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row mb-3">
                            <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                <h4 class="d-inline-block">Listagem de Papéis</h4>
                            </div>
                            <div class="col-md-3 col-sm-3 col-3">
                                <a href="{{ route('role.create') }}"
                                   class="btn btn-outline-primary btn-rounded btn-lg float-right">Novo Perfil</a>
                            </div>
                        </div>
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.del-item', function () {
                ...
                showConfirm('Excluir Perfil', 'Deseja realmente excluir este Perfil?', 'question', 'Confirmar', 'Cancelar', route, 'DELETE');
            })
