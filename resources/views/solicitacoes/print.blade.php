...
<div style='text-align: justify'>
    <p style="margin-top: .5cm;"><strong>Número:</strong> {{ $solicitacao->id }} / SSITS / {{ date('Y') }}</p>
    ...
    <p style="margin-top: 2cm;">
        <table style="width: 100%;">
            ...
            <tr>
                <td style="text-align: center;"> {{ auth()->user()->name }} {{ auth()->user()->pst_specialty }} <br> Despachante da SSITS</td>
                <td></td>
    ...
    @endif
    <p style="margin-top: 1cm; text-align: center;">CONTROLE DA SSITS</p>
