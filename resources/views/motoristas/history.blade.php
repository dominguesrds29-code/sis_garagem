                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row mb-3">
                            <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                <h4 class="d-inline-block">Historico de Autorizações de Motoristas</h4>
                            </div>
                        </div>
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.active-item', function () {
                ...
                showConfirm('Reativação de Autorização', 'Deseja realmente reativar esta autorização?', 'question', 'Confirmar', 'Cancelar', route, 'PUT');
            })
